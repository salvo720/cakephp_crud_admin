...
<?php $this->Html->css('restyle',['block'=>true]);?>
<div class="users index content">
    <?= $this->Html->link(__('New User'), ['action' => 'add'], ['class' => 'button float-right']) ?>
    <h3><?= __('Users') ?></h3>

    <?php /* = $this->Identity->get('email'); */?>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php else : ?>
                    <?= $this->Form->postLink(__('Active'), ['action' => 'userStatus', $user->id , $user->status], ['confirm' => __('Are you sure you want to active # {0}?', $user->id)]) ?>
                    <?php endif; ?>
                    </td>
